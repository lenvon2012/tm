package models.itemCopy.taobao.api.domain;

import java.util.List;
import java.util.Date;

import com.taobao.api.domain.Feature;
import com.taobao.api.domain.ItemMaterialProp;
...
public class ItemProp extends TaobaoObject {
	...
	private static final long serialVersionUID = 2141161545349724413L;
...
text(非枚举可输入)
	...
	public String toString() {
		return "ItemProp [ name="+ name+",isInputProp=" + ", isTaosir=" + isTaosir 
				+ ", must=" + must  + ", parentPid=" + parentPid + ", parentVid="
				+ parentVid + ", pid=" + pid + "]";
	}
