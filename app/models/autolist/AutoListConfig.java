...
@Entity(name = AutoListConfig.TABLE_NAME)
public class AutoListConfig extends GenericModel implements PolicySQLGenerator {
    
    @Transient
    private static final Logger log = LoggerFactory.getLogger(AutoListConfig.class);
    
    @Transient
    public static final String TABLE_NAME = "auto_list_config_new";
    
    @Transient
    public static AutoListConfig EMPTY = new AutoListConfig();
