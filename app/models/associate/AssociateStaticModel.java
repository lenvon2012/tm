...
/**
 * 插入宝贝详情页面的模板转换为HTML代码
 * @author huangyaguans@gmail.com 
 * 2014-4-3下午8:40:52
 */
public class AssociateStaticModel {
	
	private static final Logger log= LoggerFactory.getLogger(AssociateStaticModel.class);
	
	public static final String TAG= "GuanlianStaticModel";
