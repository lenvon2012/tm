...
public class PhoneItem extends TMController {


	private static final Logger log = LoggerFactory
			.getLogger(PhoneItem.class);
...
*/
        ...
        Map<Long, PromotionPlay> activePromotionMap = findAllActivePromotionNumIidMap(
                user, itemList);
	...
	public static void findExistPromotions(Long tmActivityId, String title,
		...
		List<ItemPromotionBean> promotionList = PromotionDao
				.findItemByRules(user.getId(), tmActivityId, title,
