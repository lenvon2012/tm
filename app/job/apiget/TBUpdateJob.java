...
public abstract class TBUpdateJob extends Job {

    public static final Logger log = LoggerFactory.getLogger(TBUpdateJob.class);

    public static final String TAG = "TBUpdateJob";
    ...
    public TBUpdateJob(Long userId) {
    ...
    public void doJob() {
        ...
        user = UserDao.findById(userId);
        if (user == null) {
            log.warn("No User Id with:" + userId);
            return;
        }
