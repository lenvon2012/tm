...
public class ItemApi {
    ...
    public static class ItemsPropsGetApi extends TBApi<ItempropsGetRequest, ItempropsGetResponse, JSONArray> {
        ...
        public ItemsPropsGetApi(Long cid) {
            super();
            this.cid = cid;
        }
        ...
        public ItempropsGetRequest prepareRequest() {
        	...
        	req.setFields("pid,name,is_sale_prop,is_color_prop,is_input_prop,prop_values,multi");
            req.setCid(cid);
...
//        }
    ...
    public static class MultiItemsListGet extends TBApi<ItemsSellerListGetRequest, ItemsSellerListGetResponse, List<Item>> {
        ...
        @Override
        public ItemsSellerListGetRequest prepareRequest() {
        ...
        @Override
        protected ItemsSellerListGetResponse execProcess() throws ApiException {
            return validItemListResp();
        }

        @Override
        public List<Item> validResponse(ItemsSellerListGetResponse resp) {
            if (resp == null) {
                log.error("Null Resp Returned");
                return null;
            }
...
//                log.info("[back items:]" + item.getWirelessDesc());
    ...
    public static class ItemImgsGet extends ItemGet {
        public ItemImgsGet(User user, Long numIid) {
            super(user, numIid);
        }

        public ItemImgsGet(String sid, Long numIid) {
            super(sid, numIid);
        }

        String apiFields = "num_iid,item_img";

        @Override
        public ItemSellerGetRequest prepareRequest() {
    ...
    public static class ItemFullGet extends ItemGet {
        ...
        public ItemFullGet(String sid, Long numIid) {
            super(sid, numIid);
        }
...
//            req.setId(itemImg.getId());
    ...
    public static class ItemImgPictureUpdate extends TBApi<ItemImgUploadRequest, ItemImgUploadResponse, ItemImg> {
        ...
        public ItemImgPictureUpdate(User user, Long numIid, ItemImg itemImg, FileItem fItem) {
            super(user.getSessionKey());
            this.itemImg = itemImg;
            this.user = user;
            this.numIid = numIid;
    ...
    public static class ItemImgPictureDelete extends TBApi<ItemImgDeleteRequest, ItemImgDeleteResponse, ItemImg> {
        ...
        public ItemImgPictureDelete(User user, Long numIid, Long imgId) {
            super(user.getSessionKey());
            this.imgId = imgId;
            this.user = user;
            this.numIid = numIid;
        ...
        @Override
        public ItemImgDeleteRequest prepareRequest() {
        ...
        @Override
        public ItemImg validResponse(ItemImgDeleteResponse resp) {
            if (resp == null) {
                log.error("Null Resp Returned");
                return null;
            }
    ...
    public static class ItemPropsGet extends ItemGet {
        ...
        public ItemPropsGet(String sid, Long numIid) {
            super(sid, numIid);
            this.numIid = numIid;
        }
    ...
    public static class ItemGet extends TBApi<ItemSellerGetRequest, ItemSellerGetResponse, Item> {
...
//        }
        ...
        @Override
        public ItemSellerGetResponse execProcess() throws ApiException {
            return super.validItemGetResp();
        }

        @Override
        public Item validResponse(ItemSellerGetResponse resp) {
            if (resp == null) {
                return null;
            }
...
//                log.warn("end props:" + props);
    ...
    public static class TmallItemIncrementUpdateSchemaGet extends TBApi<TmallItemIncrementUpdateSchemaGetRequest, TmallItemIncrementUpdateSchemaGetResponse, String> {

        private Long itemId;

        private String xmlData;

        public TmallItemIncrementUpdateSchemaGet(User user, Long itemId, String xmlData) {
            super(user);
            this.itemId = itemId;
        ...
        @Override
        public TmallItemIncrementUpdateSchemaGetRequest prepareRequest() {
        ...
        @Override
        public String validResponse(TmallItemIncrementUpdateSchemaGetResponse resp) {
            return resp == null ? null : resp.getUpdateItemResult();
        }
