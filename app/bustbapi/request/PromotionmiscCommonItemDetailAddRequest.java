 ...
 */
public class PromotionmiscCommonItemDetailAddRequest extends BaseTaobaoRequest<PromotionmiscCommonItemDetailAddResponse> {
	...
	* 优惠力度，其值的解释方式由promotion_type定义：当为减钱时解释成减钱数量，如：900表示减9元；当为打折时解释成打折折扣，如：900表示打9折
	...
	public Class<PromotionmiscCommonItemDetailAddResponse> getResponseClass() {
		return PromotionmiscCommonItemDetailAddResponse.class;
	}
