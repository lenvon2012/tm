...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        CodeGenerator cg = new CodeGenerator(LinezingRecord.getInstance());
//        CodeGenerator cg = new CodeGenerator(ItemPropSale.EMPTY);
    ...
    public static class DBDispatcher {
        ...
        public boolean checkExecuteQuery(String query, Object... objs) {
            query = rebuildQuery(query);
            return JDBCBuilder.checkExecuteQuery(src, query, objs);
        }
