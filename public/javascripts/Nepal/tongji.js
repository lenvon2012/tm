...
{
	var unit_id     = "2933107";
	var client_ip   = "58.205.221.201";
	var server_time = "1354257926";
	var verify_code = "16c4aca5";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2933107/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
