$(document).ready(function(){
	...
	var version_data = "b_12m";
	$("#version_youhua_6").click(function(){
		$(this).attr("style","background-position:left -228px");
		$("#version_youhua_12,#version_zhizun_6,#version_zhizun_12").removeAttr("style");
		version_data="a_6m";
	});
	$("#version_youhua_12").click(function(){
		$(this).attr("style","background-position:-252px -228px");
		$("#version_youhua_6,#version_zhizun_6,#version_zhizun_12").removeAttr("style");
		version_data="a_12m";
	});
	$("#version_zhizun_6").click(function(){
		$(this).attr("style","background-position:-505px -228px");
		$("#version_youhua_6,#version_youhua_12,#version_zhizun_12").removeAttr("style");
		version_data="b_6m";
	});
	$("#version_zhizun_12,#version_givendata").click(function(){
		$(this).attr("style","background-position:-757px -228px");
		$("#version_youhua_6,#version_youhua_12,#version_zhizun_6").removeAttr("style");
		version_data="b_12m";
	});
