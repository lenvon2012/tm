var Hashtable = function () {
    ...
    function q(d, e) {
        ...
        this.put = function (a, b) {
            ...
            h(a);
            var b = j.length;
            while (b--) if (j[b].containsValue(a)) return !0;
            return !1
        }, this.clear = function () {
            j.length = 0, k = {}
    ...
    return i.prototype = {
        ...
        containsValue: function (a) {
            ...
            while (b--) if (a === this.entries[b][1]) return !0;
            return !1
        }
    }, q
}();
(function (a) {
    ...
    function k(a, c) {
        ...
        var d = ".",
            e = ",",
            f = "-";
        c == 0 && (a.indexOf("_") != -1 ? a = a.split("_")[1].toLowerCase() : a.indexOf("-") != -1 && (a = a.split("-")[1].toLowerCase()));
        var h = b.get(a);
        if (h) {
            var k = g[h];
            k && (d = k[0], e = k[1])
    ...
    a.fn.formatNumber = function (b, c, d) {
        ...
        var c = a.extend({}, a.fn.formatNumber.defaults, c),
            d = k(c.locale.toLowerCase(), c.isFullLocale),
            e = d.dec,
            f = d.group,
            g = d.neg,
            h = "0#-,.",
        ...
        var c = a.extend({}, a.fn.formatNumber.defaults, c),
            g = k(c.locale.toLowerCase(), c.isFullLocale),
            h = g.dec,
            i = g.group,
            j = g.neg,
            l = !1;
        ...
        var i = "",
            j = !1;
        if (b.charAt(b.length - 1) == "%" || c.isPercentage == 1) j = !0;
...
function (a) {
    ...
    b.prototype.oninit = function () {}, b.prototype.events = function () {}, b.prototype.onmousedown = function () {
        ...
        var b = this;
        this.supportTouches_ = a.browser.webkit && navigator.userAgent.indexOf("Mobile") != -1, this.events_ = {
...
function (a) {
    ...
    d.prototype.init = function (b, d) {
    	...
    	if (typeof MM.taoci !== "undefined") {
    		MM.taoci.data_filter();
    	}
