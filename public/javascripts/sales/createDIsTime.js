...
((function ($, window) {
    ...
    TM.createDisTime = TM.createDisTime || {};

    var createDisTime = TM.createDisTime || {};

    createDisTime.init = createDisTime.init || {};
    createDisTime.init = $.extend({
        ...
        doInit: function(container) {
            ...
            $.ajax({
                ...
                success : function(dataJson) {
                    ...
                    createDisTime.init.doWithNowTime(container, nowTime);
        ...
        doWithNowTime: function(container, nowTime) {
            ...
            createDisTime.container = container;

            var description = createDisTime.init.getDefaultDescription(nowTime);
            ...
            container.find(".submit-add-activity-btn").click(function() {
                ...
                $.ajax({
                    ...
                    success : function(dataJson) {
                        ...
                        location.href = '/Sales/addPromotion?activityId=' + activityId;
                    }
                });
        ...
        getContainer: function() {
            return createDisTime.container;
        }
