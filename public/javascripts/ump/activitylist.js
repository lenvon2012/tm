        ...
        initNewActivityEvent: function(activityJson, trObj) {
            ...
            if (ActivityList.util.isDiscountActivity(activityJson) || ActivityList.util.isNewDiscountActivity(activityJson)) {
                ...
                trObj.find(".reviseItem").unbind().click(function() {
                    var href="/umppromotion/modifyPromotion?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                });
                trObj.find(".addItem").unbind().click(function(){
                    var href="/umppromotion/addPromotion?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                }) ;
                trObj.find(".reviseAct").unbind().click(function(){
                    var href="/umpactivity/modifyDiscount?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                }) ;
                trObj.find(".restart-activity-btn").unbind().click(function() {
                    var href="/umpactivity/restartDiscount?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                });
                ...
                trObj.find(".reviseItem").unbind().click(function() {
                    var href="/taodiscount/mjsItemSelect?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                });
                trObj.find(".addItem").unbind().click(function(){
                    var href="/UmpMjs/mjsItemAdd?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                }) ;
                trObj.find(".reviseAct").unbind().click(function(){
                    //修改活动
                    var href="/UmpMjs/mjsUpdateActivity?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                }) ;
                trObj.find('.restart-activity-btn').unbind("click").click(function(){
                    // 重启活动
                    var href="/Taodiscount/mjsRestartActivity?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                });
                ...
                trObj.find(".reviseAct").unbind().click(function(){
                    //修改活动
                    var href="/UmpMjs/mjsShopUpdateActivity?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                });
                trObj.find('.restart-activity-btn').unbind("click").click(function(){
                    // 重启活动
                    var href="/Taodiscount/mjsRestartShopActivity?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                });
                ...
                trObj.find(".reviseAct").unbind().click(function(){
                    //修改活动
                    var href="/umpactivity/modifyShopDiscount?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                });

                trObj.find('.restart-activity-btn').unbind("click").click(function(){
                    var href="/umpactivity/restartShopDiscount?activityId=" + activityJson.id;
                    location.href = href;
                    return false;
                });
