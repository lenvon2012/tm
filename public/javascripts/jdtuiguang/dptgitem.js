...
//                '       </table>' +
    ...
    DptgItem.row = $.extend({
        createRow: function(index, itemJson) {
            ...
            var href = "http://item.jd.com/" + itemJson.skuId + ".html";
            ...
            trObj.find(".item-price").html(itemJson.price/100);
            ...
            if (itemJson.popularized == true && (itemJson.status&1) == 1) {
                var html = '' +
...
((function ($, window) {
    ...
    DptgBatchOp.submit = $.extend({
        ...
        batchCancel: function(numIidArray) {
            ...
            data.status = 5;
            $.ajax({
                url : '/jdpromote/removePopularized',
                data : data,
                type : 'post',
                success : function(dataJson) {
                    alert("取消推广宝贝成功！");
        ...
        shopPopularized: function() {
            ...
            $.ajax({
                url : '/jdpromote/addPopularizedAll',
                data : data,
                type : 'post',
                success : function(dataJson) {
        ...
        shopCancel: function() {
            ...
            data.status = 5;
            $.ajax({
                url : '/jdpromote/removePopularizedAll',
                data : data,
                type : 'post',
                success : function(dataJson) {
                    alert("全店取消推广成功");
