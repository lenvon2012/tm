    ...
    RelationOp.row = $.extend({
        createRow: function(index, itemJson) {
            ...
            var html2 =''+
                ...
                '   <tbody>' +
                '   <tr class="head-tr">' +
                '       <td  class="top-1"  ><input style="width: 20px;height: 20px;" type="checkbox" class="item-checkbox" /></td>' +
                '       <td  class="top-2"  colspan="7"></td>' +
                '   </tr>' +
                '   <tr>' +
                '       <td  style="width: 5%;">' +
                '       <td  style="width: 15%;">' +
                ...
                '       </td>' +*/
                '       <td style="border: 1px solid #ccc;width: 25%;" colspan="2">' +
                '           销量 : <span style="color: red;margin-left: 10px;">' + itemJson.salesCount + '</span>' +
                '       </td>' +
            ...
            trObj.find(".body-liulanImg").attr("src","http://img01.taobaocdn.com/top/i1/T10jtLFathXXaCwpjX.png");
