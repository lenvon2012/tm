                            ...
                            $.get('/status/user',function(data){
                                ...
                                if(interval > 7*24*3600*1000){
                                    var html = ''+
                                        ...
                                        '<a target="_blank" href="http://fuwu.taobao.com/serv/manage_service.htm?spm=a1z13.1113649.0.0.wRvp1i&service_code=ts-10452">' +
    ...
    RelationOp.row = $.extend({
        createRow: function(index, itemJson) {
            ...
            var html2 =''+
                ...
                '            <div class="body-liulan"><img class="body-liulanImg" /></div> ' +
            ...
            trObj.find(".body-liulanImg").attr("src","/img/dazhe/liuliangbao40_40.png");
            ...
            $.get('/Relation/getRelatedRecommends',{numIid: itemJson.numIid},function(data){
                 $.each(data, function(i, item){
                     ...
                     obj.find(".relation-link").attr("href", "http://item.taobao.com/item.htm?id="+item.id);
