...
((function ($, window) {
    ...
    AddPromotion.init = $.extend({
        ...
        doInit: function(container) {
            ...
            $.ajax({
                url : '/PhoneItem/findDazheActivity',
                data : paramData,
                type : 'post',
...
//                        location.href = "/PhoneDetaileds/comList";
//                        return;
//                    }
...
//                    container.find(".add-item-header").html("添加促销商品 &nbsp;(当前活动：" + activityJson.activityDescription + ")");
    ...
    NewDiscount.event = $.extend({
        ...
        initSubmitEvent: function() {
            ...
            container.find(".submit-discount-btn").unbind().click(function() {
                ...
                $.ajax({
                    url : '/PhoneItem/submitAddPromotions',
                    data : paramData,
                    type : 'post',
                    success : function(dataJson) {
