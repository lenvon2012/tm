...
((function ($, window) {
    ...
    AddPromotionCommon.reload = $.extend({
        ...
        initActivityPromotionCount: function() {
            ...
            $.ajax({
                url : '/PhoneItem/countActivityActivePromotions',
                data : paramData,
                type : 'post',
        ...
        doSearchWithPage: function(currentPage, isAddPageModifyPromotions) {
            ...
            container.find(".promotion-paging-div").tmpage({
                ...
                ajax: {
                    ...
                    param: paramData,
                    dataType: 'json',
                    url: '/PhoneItem/queryPromotionSelectedItems',
    ...
    AddPromotionCommon.event = $.extend({
        ...
        initNextStepEvent: function(outContainer) {
            ...
            container.find(".goto-set-discount-btn,.item-list").click(function() {
...
//                },"测试一下");
        ...
        createTmpls:function(selectNumIidStr){
            ...
            $.ajax({
                "url":"/PhoneDetaileds/createData",
                "type":"post",
                "data":{"commodityIds":selectNumIidStr},
                "dataType":"json",
                "async":false,
        ...
        createAllPhones:function(){
            ...
            $.ajax({
                "url":"/PhoneDetaileds/createAllPhones",
                "type":"post",
                "dataType":"json",
                "async":false,
                "success":function(data){
