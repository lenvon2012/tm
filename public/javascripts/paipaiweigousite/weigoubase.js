    ...
    WeigouBase.event = $.extend({
        doInit: function() {
            ...
            $(".item-search-btn").click(function() {
                ...
                var action = "/PaiPaiPromoteSite/weigou";
                //numIid
...
((function ($, window) {
    ...
    WeigouHot.show = $.extend({
        ...
        firstShow: function() {
            ...
            WeigouHot.show.doShow(data, '/PaiPaiPromoteSite/randomUserItems');
        },
        scrollShow: function() {
            var data = {};
            WeigouHot.show.doShow(data, '/PaiPaiPromoteSite/randomItems');
        },
