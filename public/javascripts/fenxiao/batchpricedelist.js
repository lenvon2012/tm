    ...
    SkinBatch.init = $.extend({
        ...
        initBatchOpDiv: function() {
            ...
            if (SkinBatch.init.isModifyPrice != true) {
                html += '               <td><span class="tmbtn wide-sky-blue-btn batch-list-btn">选中宝贝上架</span> </td>' +
                    '               <td><span class="tmbtn wide-yellow-btn batch-delist-btn">选中宝贝下架</span> </td>';
            } else {
                html += '               <td><span class="tmbtn long-green-btn batch-modify-price-btn">修改选中宝贝价格</span> </td>';
            }
        ...
        initItemContainer: function() {
            ...
            if (SkinBatch.init.isModifyPrice != true) {
                html = '' +
                    ...
                    '       <td style="width: 12%;"><div class="sort-td sort-down" orderBy="delist">下架时间</div></td>' +
                    '       <td style="width: 12%;"><div class="sort-td sort-down" orderBy="price">价格</div></td>' +
                ...
                html = '' +
                    ...
                    '       <td style="width: 15%;"><div class="sort-td sort-down" orderBy="price">价格</div></td></td>' +
                    '   </tr>' +
                    '   </thead>' +
                    '   <tbody class="item-list-tbody"></tbody>' +
                    '</table>' +
