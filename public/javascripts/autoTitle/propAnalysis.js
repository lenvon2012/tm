...
((function($, window){
    ...
    var me = autoTitle.CatAnalysis;
    var level1Cid = null;
    autoTitle.CatAnalysis = $.extend(autoTitle.CatAnalysis, {
        currActive: null,
        currTab: null,
        currCid: null,
        currYear: null,
        ...
        initLevelSelect: function(container){
            $.ajax({
                url: '/buskey/myallcats',
                data: {},
                type: 'get',
                async: false,
                success: function(data){
                     var container = $('.shopCats');
                     var body = container.find('.placeHolder');
                     var tmpl = container.find('.tmpl');
                     body.empty();
                     body.append(tmpl.tmpl(data));
                     body.find('.shopitemcatsapn').click(function(){
                         var tag = $('.tabDiv .select').attr('targetdiv');
                         var cid = $(this).attr('cid');
                         var cname = $(this).attr('cname');
                         if (cid === me.currCid) {
                             return;
                         }
                         me.renderAdapter(tag, cid, cname);
                     });
                }
            });
            $.ajax({
                ...
                success: function(data){
                    ...
                    autoTitle.CatAnalysis.MonthSelect(container);
                }
            });
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (data == null) {
                            ...
                            autoTitle.CatAnalysis.ShowInfo(container);
                            autoTitle.CatAnalysis.Level1Select(container);
                        }
                    }
                });
...
//                                console.log(data);
        ...
        createNewHighChart: function(cid, pid, container){
            ...
            $.get('/items/catPropSale', {
                cid: cid,
                pid: pid
            }, function(res){
                if (res != null && res.length > 0) {
                    autoTitle.CatAnalysis.genHighChart(pid, res);
                }
            });
        },
        ...
        genHighChart: function(id, list){
            ...
            autoTitle.CatAnalysis.currActive = target;
            ...
            var pvArr = autoTitle.CatAnalysis.createSaleArr(list);
