...
((function ($, window) {
    ...
    PromotionSelectItem.init = $.extend({
        doInit: function(container, userParams) {
            ...
            promotionParams.searchUrl =TM.serverPath+ '/PhoneItem/searchPromotionAddItems';
    ...
    PromotionSelectItem.reload = $.extend({
        ...
        initExistPromotionsCount: function() {
            ...
            $.ajax({
                url : TM.serverPath+'/PhoneItem/countActivityActivePromotions',
                data : paramData,
                type : 'post',
