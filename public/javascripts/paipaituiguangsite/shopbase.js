...
((function ($, window) {
    ...
    ShopBase.init = $.extend({
        ...
        createNav: function() {
            var html = '' +
                '<tr>' +
                '    <td><a class="nav-link first-page-link" href="/PaiPaiPromoteSite/aituiguang">首页</a></td>' +
                '    <td><a class="nav-link" href="/PaiPaiPromoteSite/aituiguang?topcat=1">女装</a></td>' +
                '    <td><a class="nav-link" href="/PaiPaiPromoteSite/aituiguang?topcat=2">男装</a></td>' +
                '    <td><a class="nav-link" href="/PaiPaiPromoteSite/aituiguang?topcat=3">鞋子</a></td>' +
                '    <td><a class="nav-link" href="/PaiPaiPromoteSite/aituiguang?topcat=4">包包</a></td>' +
                '    <td><a class="nav-link" href="/PaiPaiPromoteSite/aituiguang?topcat=5">美容</a></td>' +
                '    <td><a class="nav-link" href="/PaiPaiPromoteSite/aituiguang?topcat=6">家居</a></td>' +
                '    <td><a class="nav-link" href="/PaiPaiPromoteSite/aituiguang?topcat=7">母婴</a></td>' +
                '    <td><a class="nav-link" href="/PaiPaiPromoteSite/aituiguang?topcat=8">数码</a></td>' +
                '    <td><a class="nav-link" href="/PaiPaiPromoteSite/aituiguang?topcat=9">美食</a></td>' +
                '    <td><a class="nav-link" href="/PaiPaiPromoteSite/aituiguang?topcat=10">随意淘</a></td>' +
                '</tr> ' +
                '';
