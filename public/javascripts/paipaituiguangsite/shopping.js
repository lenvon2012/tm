...
((function ($, window) {
    ...
    Shopping.search = $.extend({
        initEvent: function() {
            ...
            $(".item-search-btn").click(function() {
                ...
                var action = "/PaiPaiPromoteSite/aituiguang";
    ...
    Shopping.show = $.extend({
        ...
        firstShow: function() {
            ...
            Shopping.masonry.isFollowOrder = true;
            Shopping.show.doShow(data, '/PaiPaiPromoteSite/randomUserItems');
        },
        scrollShow: function() {
            var data = {};
            Shopping.show.doShow(data, '/PaiPaiPromoteSite/randomItems');
        },
