...
*/
                ...
                '                       </tr>' +
                /*'                       <tr>' +
                '                           <td colspan="2"><div><a class="big-op-btn" href="/paipailetuiguang/promoteItem">我 要 推 广</a></div></td>' +
                '                       </tr>' +*/
                '                   </tbody>' +
                '               </table> ' +
                '           </td>' +
                ...
                '               <div><a class="big-op-btn" href="/paipailetuiguang/promoteItem">我 要 推 广</a></div>' +
                '               <div  style="margin-top: 30px;display:none;"><a class="big-op-btn" target="_blank" href="http://www.letuiguang.com/">查 看 推 广</a></div>' +
                '           </td>' +
                '       </tbody>' +
                '   </table> ' +
                '</div>' +
                ...
                '</div><div class="blank0" style="height:15px"></div>'+
                '</div>';
